...
int ENA = 10; // Arduino PWM Pin 10 to ENA on L298n Board
int IN1 = 9;  // Arduino Digital Pin 9 to IN1 on L298n Board 
int IN2 = 8;  // Arduino Digital Pin 8 to IN2 on L298n Board
 
int ENB = 5;  // Arduino PWM Pin 5 to ENB on L298n Board
int IN3 = 7;  // Arduino Digital pin 7 to IN3 on L298n Board
int IN4 = 6;  // Arduino Digital pin 6 to IN4 on L298n Board
